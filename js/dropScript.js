if (document.querySelector('.drop-zone-desc')) {
    const dropZone = document.querySelector('.drop-zone-desc');
...
if (document.querySelector('.drop-zone-popup')) {
    const dropZone = document.querySelector('.drop-zone-popup');
    // для дроп зоны сделай фор ич
    const inputFile = dropZone.querySelector('#inputFile');
